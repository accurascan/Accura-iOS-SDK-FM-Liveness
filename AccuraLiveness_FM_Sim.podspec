Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/accurascan/Accura-iOS-SDK-FM-Liveness.git", :tag => "4.4.0.7.3" }
  spec.preserve_paths = 'AccuraLiveness_fm.xcframework'
  spec.vendored_frameworks = 'AccuraLiveness_fm.xcframework'
